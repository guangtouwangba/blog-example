...
import (
	...
	tutorialv1beta1 "jerry.org/tutorial/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=tutorial.jerry.org,resources=foos,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tutorial.jerry.org,resources=foos/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tutorial.jerry.org,resources=foos/finalizers,verbs=update
